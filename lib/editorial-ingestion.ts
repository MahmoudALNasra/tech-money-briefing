      ...
      },
      {
        ...
        content: JSON.stringify({
          ...
          instructions: [
            ...
            "Follow Google's generative AI Search guidance: create helpful, reliable, people-first content with a distinct operator point of view instead of commodity summaries.",
            "Do not create thin query-variation content, keyword stuffing, AEO/GEO hacks, fake first-hand experience, or inauthentic mentions.",
